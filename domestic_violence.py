            ...
            dbc.Col([html.Span("14 women and 2 children", className="big-numbers"
                     ...
                     html.P(
                         [
                             ...
                             dcc.Link("[Counting Dead Women]",
                                      href="https://kareningalasmith.com/2020/04/15/coronavirus-doesnt-cause-mens-violence-against-women/")]),
                     ...
                     html.P(
                         [
                             ...
                             dcc.Link("[ONS]",
                                      href="https://www.ons.gov.uk/peoplepopulationandcommunity/crimeandjustice/bulletins/domesticabuseinenglandandwalesoverview/november2019")
                         ])
                     ])
        ])
    ]

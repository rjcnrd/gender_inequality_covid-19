            ...
            dbc.Col([html.Span("14 women and 2 children", className="big-numbers"
                     ...
                     html.P(
                         [
                             ...
                             dcc.Link("[Counting Dead Women]",
                                      href="https://kareningalasmith.com/2020/04/15/coronavirus-doesnt-cause-mens-violence-against-women/", target='_blank')]),
                     ...
                     html.P(
                         [
                             ...
                             dcc.Link("[Refuge]",
                                      href="https://www.refuge.org.uk/25-increase-in-calls-to-national-domestic-abuse-helpline-since-lockdown-measures-began/", target='_blank')
                         ]),
                     ...
                     html.P(
                         [
                             ...
                             dcc.Link("[ONS]",
                                      href="https://www.ons.gov.uk/peoplepopulationandcommunity/crimeandjustice/bulletins/domesticabuseinenglandandwalesoverview/november2019", target='_blank')
                         ])
                     ])
        ])
    ]
